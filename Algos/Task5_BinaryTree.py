...
3.实现二叉树前、中、后序以及层次遍历
4.并完成leetcode上的验证二叉搜索树(98)及二叉树层次遍历(102,107)

[树的高度和深度]

对于高度的理解，我们不管他数据结构什么什么知识，就拿楼房来说，假如一个人提问：楼房的高度有好高？
我们会下意识的从底层开始往上数，假如楼有6层，则我们会说，这个楼有6层楼那么高，则提问者就会大概知道楼有多高了。
所以高度就是以从下往上对比，这是我们的习惯。而在树中，树的高度也是从下往上数。

高度的定义为：从结点x向下到某个叶结点最长简单路径中边的条数，初值是1。
E.G.
         A
        / \
       B   C
